...
Banner.prototype.showImg = function(inOrd,outOrd){
...
Banner.prototype.showLi=function(){
	//    B、改豆豆		
...
Banner.prototype.showp=function(){
	//图片分左右
...
//2、停止播放
Banner.prototype.stopChange=function(){
	//停止定时器
	window.clearInterval(this.myTimer);
}

//4、跳转到指定的图片
Banner.prototype.goImg=function(transOrd){//1
